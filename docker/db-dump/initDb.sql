...
VALUES 	((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Human'),3,0,3,0,3,0,3,0,3,0,3,0,3,0,3,0,2,0,0,'Any, usually lean toward good and selfish',0,0),
        ...
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troglodyte'),2,0,2,0,3,0,4,4,3,6,3,0,2,0,6,0,2,0,13,'Typically anarchist or evil; but most player characters are likely to be unprincipled, anarchist, aberrant or even good',1,0),
        ...
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre'),3,0,3,0,2,0,4,4,3,0,3,6,2,0,3,0,3,0,10,'Typically anarchist or evil, but most player characters are likely to be unprincipled, anarchist, aberrant or even good',0,0),
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll'),3,0,2,0,2,0,4,10,4,0,3,6,1,4,2,0,3,0,12,'Typically anarchist or evil, but most player characters are likely to be unprincipled, anarchist, aberrant or even good',0,0),
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling'),3,0,4,6,4,0,3,0,3,0,2,0,2,0,2,0,5,0,10,'Any',0,0),
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen'),3,0,3,0,2,0,4,1,3,0,3,0,3,0,4,0,3,0,12,'Any, but tend toward principled and aberrant, both alignments with a strong personal code of honor',0,0),
        ((SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle'),3,0,3,0,2,0,3,1,4,1,3,0,3,0,3,0,3,0,11,'Any, but tend toward anarchist and miscreant; the antithesis of the noble Wolfen',0,0);
...
VALUES  ('NONE SELECTED', (SELECT ot.Id FROM palladium.OCCType ot WHERE ot.`Desc` = 'NONE')),
        ...
        ('Goblin Cobbler',(SELECT ot.Id FROM palladium.OCCType ot WHERE ot.`Desc` = 'Racial'));
...
VALUES  ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Human')),
        ...
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Healer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Mystic'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psychic Sensitive'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Goblin Cobbler'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Hob-Goblin')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Orc')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Monk'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Light'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Knight'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Long Bowman'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Palladin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Ranger'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Merchant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Noble'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Scholar'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Squire'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Peasant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Farmer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Diabolist'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Summoner'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Warlock'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Wizard'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mind Mage'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Healer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Mystic'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psychic Sensitive'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Ogre')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Monk'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Light'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Knight'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Long Bowman'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Palladin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Ranger'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Merchant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Noble'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Scholar'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Squire'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Peasant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Farmer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Diabolist'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Summoner'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Warlock'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Wizard'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Troll')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Monk'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Light'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Knight'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Long Bowman'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Palladin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Ranger'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Merchant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Noble'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Scholar'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Squire'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Peasant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Farmer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Diabolist'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Summoner'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Warlock'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Wizard'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mind Mage'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Healer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Mystic'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psychic Sensitive'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Changeling')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Monk'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Light'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Knight'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Long Bowman'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Palladin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Ranger'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Merchant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Noble'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Scholar'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Squire'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Peasant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Farmer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Diabolist'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Summoner'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Warlock'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Wizard'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mind Mage'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Healer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Mystic'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psychic Sensitive'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Wolfen')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Druid'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Monk'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Light'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Priest of Darkness'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Assassin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Knight'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Long Bowman'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mercenary Warrior'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Palladin'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Ranger'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Soldier'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Thief'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Merchant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Noble'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Scholar'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Squire'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Vagabond'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Peasant'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Farmer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Diabolist'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Summoner'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Warlock'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Witch'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Wizard'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Mind Mage'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Healer'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psi-Mystic'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle')),
        ((SELECT o.Id FROM palladium.OCC o WHERE o.Desc = 'Psychic Sensitive'),(SELECT r.Id FROM palladium.Race r WHERE r.`Desc` = 'Coyle'));
